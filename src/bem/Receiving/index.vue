<template>
    <div class="Receiving buefy" v-if="currentProject && currentProject.receiving">
        ...
        <h2 v-html="$t('Receiving', {Token:currentProject.receiving.symbol})"></h2>
        ...
        <table v-if="!isPendingTx && !isErrorTx" class="table table-striped table-bordered table-hover table-responsive-sm">
            <tbody>
            <tr>
                <td v-html="$t('ReceivingUnsold', {Token:currentProject.receiving.symbol})"></td>
                <td>{{ currentProject.receiving.amountUnSold }} {{ currentProject.receiving.symbol }}</td>
            </tr>
            <!--<tr>-->
                <!--<td><span v-html="$t('ReceivingRemaining', {Token:currentProject.receiving.symbol, WToken:currentProject.receiving.symbolW})"></span>-->
                <!--</td>-->
                <!--<td>{{ currentProject.receiving.amountRemainingInTokenChanger }} {{ currentProject.receiving.symbol }}</td>-->
            <!--</tr>-->
            <!--<tr>-->
                <!--<td v-html="$t('ReceivingAfterExchanging', {Token:currentProject.receiving.symbol, WToken:currentProject.receiving.symbolW})">-->
                <!--</td>-->
                <!--<td>{{ currentProject.receiving.amountRemainingAfterTheExchange }} {{ currentProject.receiving.symbol }}</td>-->
            <!--</tr>-->
            <!--<tr>-->
                <!--<td v-html="$t('ReceivingTotal', {Token:currentProject.receiving.symbol})"></td>-->
