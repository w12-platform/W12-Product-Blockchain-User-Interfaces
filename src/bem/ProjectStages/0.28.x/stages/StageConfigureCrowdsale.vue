...
<script>
    import './default.scss';
    import { conversionByDecimals } from '@/lib/selectors/units';
    import { decodeUSD, encodeUSD, errorMessageSubstitution, waitContractEventOnce } from '@/lib/utils';
    ...
    export default {
        ...
        methods: {
            ...
            async addTokensToCrowdSale() {
                ...
                const data = this.crowdsaleInitForm;
                const amountForSale = conversionByDecimals(data.amountForSale, this.currentProject.decimals);
                ...
                try {
                    ...
                    const event = waitContractEventOnce(W12Lister, 'CrowdsaleTokenMinted', {
                        token: this.currentProject.tokenAddress,
