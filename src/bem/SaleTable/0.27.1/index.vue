    ...
    <div class="SaleTable buefy" v-if="currentToken && saleTableData">
        ...
        <b-table :data="saleTableData" class="table table-striped table-bordered table-responsive-sm"
            ...
            <template slot-scope="props">
                ...
                <b-table-column :visible="Boolean(props.row.bonusVolume.length)" field="volume" :label="$t('InvestorDashboardDiscountsAmountTitle', { currency: 'USD' })" centered>
                ...
                <!--<b-table-column :visible="Boolean(props.row.bonusVolume.length)" field="bonusVolume" label="Token amount with discount" centered>-->
                <!--<div class="SaleTable__volumeElem" v-for="bonusVolume in props.row.bonusVolume.slice().reverse()">-->
