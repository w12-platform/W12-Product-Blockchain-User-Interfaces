...
export class W12CrowdsaleWrapper extends BaseWrapper {
    ...
    packSetupCrowdsaleParameters(stages, milestones, paymentMethods) {
        ...
        const pack6 = paymentMethods.map(m => web3.fromUtf8(m));
    ...
    async setup(stages, milestones, paymentMethods) {
        return await this.methods.setup(...this.packSetupCrowdsaleParameters(stages, milestones, paymentMethods));
    }
